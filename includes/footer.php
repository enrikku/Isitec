...
<footer class="custom-footer-bg text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
    <div
        ...
        <div class="flex justify-center">
            ...
            <a id="openLinkedinProfiles" class="me-6 [&>svg]:h-4 [&>svg]:w-4 cursor-pointer">
            ...
            <script>
            document.getElementById('openLinkedinProfiles').addEventListener('click', function() {
                // Abre el primer perfil de LinkedIn en una nueva pestaña
                window.open('https://www.linkedin.com/in/francisco-rus-gonzalez-3b8b51242/', '_blank');
                // Abre el segundo perfil de LinkedIn en otra nueva pestaña
                window.open('https://www.linkedin.com/in/enric-cabeza-p%C3%A9rez-b0546a205/', '_blank');
            });
            </script>

            <a href="https://github.com/enrikku/Isitec.git" target="_blank" class="[&>svg]:h-4 [&>svg]:w-4">
            ...
            <div class="">
                <h6 class="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                    <span class="me-3 [&>svg]:h-4 [&>svg]:w-4">
                        ...
                        <svg fill="#C7C9CD" height="200px" width="200px" version="1.1" id="Capa_1"
                ...
                <p>
                    Isitec es una plataforma de aprendizaje que ofrece una amplia variedad de cursos
                    especializados en programación y tecnologías de la información. Nos esforzamos por democratizar la
                    educación en tecnología, conectando a estudiantes de
                    todo el mundo con los mejores instructores del sector.
                </p>
            </div>
            <!-- Products section -->
            <div>
    ...
    <div class="bg-black/5 p-6 text-center">
        ...
        <a class="font-semibold" href="https://isitec.cat" target="_blank">Isitec</a>
    </div>
</footer>