    ...
    <div class="min-h-full">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/isitec/public/cursos/addCourse.php"
                                    class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Añadir curso</a>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="relative ml-3">
                                ...
                                <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                    ...
                                    <a href="..\controller\logout.php" class="block px-4 py-2 text-sm text-gray-700"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <!-- //TODO: poner el tamaño de letra responsive que no me rompa el diseño -->
                ...
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    ...
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="../assets/img/jesse.png" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        </div>
                        <!-- Item 2 -->
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="../assets/img/pau.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        </div>
                        <!-- Item 3 -->
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="px-6 py-4 mb-auto">
                <a href="#"
                    ...
                    <div class="flex gap-2">
                        ...
                        <button class="py-1.5 px-3 hover:text-red-600 hover:scale-105 hover:shadow text-center border border-gray-300 rounded-md border-gray-400 h-8 text-sm flex items-center gap-1 lg:gap-2">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
