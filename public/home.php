    ...
    <div class="min-h-full">
        ...
        <main>
            ...
            <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
                ...
                <div class="rounded overflow-hidden shadow-lg flex flex-col">
                    <!-- Link a otra página o modal con más detalles del curso -->
                    <a href="curso_detalle.php?id=<?php echo htmlspecialchars($curso['courseId']); ?>">
                        <!-- Imagen del curso -->
                    ...
                    <div class="px-6 py-4 mb-auto">
                        <!-- Título del curso -->
                        <div class="font-bold text-xl mb-2"><?php echo htmlspecialchars($curso['title']); ?></div>
                        <!-- Descripción del curso -->
                        <p class="text-gray-700 text-base"><?php echo htmlspecialchars($curso['description']); ?></p>
                    </div>
                    ...
                    <div class="px-6 py-4">
                        <!-- Votos positivos y negativos del curso -->
                        Likes: <?php echo $curso['votos']['likes'] ?? 0; ?>
                        Dislikes: <?php echo $curso['votos']['dislikes'] ?? 0; ?>
                    </div>
                </div>
                <?php endforeach;?>
